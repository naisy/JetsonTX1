...
> /mnt/Jetson-SSD500/package_build/opencv-3.4.1/DEBIAN/control \
&& fakeroot dpkg-deb --build opencv-3.4.1

mkdir -p $SCRIPT_DIR/../binary
mv -f /mnt/Jetson-SSD500/package_build/opencv-3.4.1.deb $SCRIPT_DIR/../binary
